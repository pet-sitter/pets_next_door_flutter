...
final loginViewControllerProvider =
    AutoDisposeAsyncNotifierProvider<LoginViewController, void>.internal(
  LoginViewController.new,
  name: r'loginViewControllerProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$loginViewControllerHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef _$LoginViewController = AutoDisposeAsyncNotifier<void>;
