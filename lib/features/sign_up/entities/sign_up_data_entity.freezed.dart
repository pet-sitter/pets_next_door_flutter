...
class _$_SignUpDataEntity extends _SignUpDataEntity {
  ...
  @override
  String toString() {
    return 'SignUpDataEntity(firebaseProviderType: $firebaseProviderType, firebaseUid: $firebaseUid, email: $email, fullname: $fullname, nickname: $nickname, pets: $pets, profileImageId: $profileImageId)';
  }
